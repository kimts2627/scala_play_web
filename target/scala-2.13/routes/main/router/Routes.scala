...
class Routes(
  ...
  // @LINE:10
  private[this] lazy val controllers_HomeController_todo3_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("todo")))
  )
  private[this] lazy val controllers_HomeController_todo3_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:10
    case controllers_HomeController_todo3_route(params@_) =>
      call { 
        controllers_HomeController_todo3_invoker.call(HomeController_1.todo())
      }
